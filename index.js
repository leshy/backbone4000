...
(function(){
  var ref$, map, fold1, keys, values, first, flatten, _, h, Backbone, metaExtender, extender, metaClassers, slice$ = [].slice;
  ...
  Backbone.Model.extend4000 = Backbone.View.extend4000 = Backbone.Collection.extend4000 = function(){
    ...
    _.map(newClass.meta, function(morpher){
      return morpher(newClass);
    });
